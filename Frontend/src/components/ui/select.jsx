...
import { Check, ChevronDown, ChevronUp, Flag, Goal } from "lucide-react";
...
const SelectTrigger = React.forwardRef(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-8 w-full items-center justify-between rounded-md border border-neutral-200 bg-white px-3 py-2 text-sm placeholder:text-neutral-500 outline-none disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1 dark:border-neutral-800 dark:bg-neutral-950 dark:placeholder:text-neutral-400 ",
      className
    )}
    {...props}
  >
...
const SelectItem = React.forwardRef(({ className, children, showColor, ...props }, ref) => (
